...
import id.fdl.tugas3.R;


public class NotificationAlarmFragment extends Fragment {
    ...
    public static NotificationAlarmFragment newInstance(){ return new NotificationAlarmFragment();}
